                ...
                <div className="grid grid-cols-2 gap-5 p-5">
                    ...
                    <div className="flex flex-col">
                        <div className="py-0 my-0 flex text-[11px]">
                            <span className="font-bold px-1">Location:</span>
                            <span className="px-1">{property.location}</span>
                        </div>
                        <div className="py-0 my-0 flex text-[11px]">
                            <span className="font-bold px-1">Price:</span>
                            <span className="px-1">
                        ...
                        <div className="py-0 my-0 flex text-[11px]">
                            <span className="font-bold px-1">Floor Area:</span>
                            <span className="px-1">{property.floorArea} sqm</span>
                        </div>
                        <div className="py-0 my-0 flex text-[11px]">
                            <span className="font-bold px-1">Lot Area:</span>
                    ...
                    <div className="flex flex-col">
                        <div className="flex text-[11px] py-0 my-0">
                            <span className="font-bold px-1">Direct Sales Marketing Assistant:</span>
                            <span className="px-1">Carla Flores</span>
                        </div>
                        <div className="flex text-[11px] py-0 my-0">
                            <span className="font-bold px-1">PRC Licensed Number:</span>
                            <span className="px-1">0016602</span>
                        </div>
                        <div className="flex text-[11px] py-0 my-0">
                            <span className="font-bold px-1">Contact #:</span>
                    ...
                    <div className="flex flex-col col-span-2">
                        ...
                        <div className="grid grid-cols-3 gap-4 col-span-2">
                            {property.images.slice(0, 15).map((image, index) => (
                                <div key={index} className="p-2 w-full h-32">
                                    <img
                                        src={image}
